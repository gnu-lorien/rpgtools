...
Sabbat will recognize another vampire‚Äôs intelligence and ambition, \
...
justified as ‚Äúmonitoring your brothers‚Äù (such as Scry, \
...
These might include cutting off the offender‚Äôs finger \
...
powers in the presence of an officer of your sect, unless you \
    receive the officer‚Äôs express permission. Further, you may \
not feed within your sect‚Äôs territories, but must seek scraps \
...
no character can benefit from a single individual‚Äôs \
...
receives Forsaken."
  },
  {
    name: "Forsaken",
    type: "negative",
    flavor: "You have broken society‚Äôs boundaries so often that the sect has \
...
without repercussion from your sect. Society‚Äôs laws \
...
by their sect as part of a formal hunt for that character‚Äôs \
...
praise and respect, or command punishment ‚Äì corporal or capital \
‚Äì to all those within.",
...
to enforce justice anywhere within the sect‚Äôs dominion. You can \
...
individual either Courageous or Loyal."
  },
  {
    name: "Enforcer",
    type: "abiding",
    flavor: "You are authority‚Äôs right hand. You have the power to enforce \
society‚Äôs laws and to ensure punishment for those who break the \
...
individual the fleeting status Favored."
  },
  {
    name: "Prominent",
    type: "abiding",
    flavor: "You are society‚Äôs voice, and others listen to you on matters of \
...
targeted by another character‚Äôs use of the Subterfuge \
  ...
  },
{
  ...
  venue: "Camarilla",
  type: "abiding",
  flavor: "You are an ultimate authority within the Camarilla. Your voice can shake political mountains and alter the sectís future.",
...
them ìProfane,î while Harpies may punish someone \
who has been proven to have broken a legitimate boon, \
calling them ìBoonbreaker.î"
},
{
  name: "Noble",
  venue: "Camarilla",
...
status Forsaken while in that Princeís city. This has no \
...
your name, the item will be listed simply as, ìSubmitted \
for consideration by an Architect of the Camarilla.î"
},
{
...
Authority status ìoutranksî other possessors of Authority. \
...
another characterís Authority, Established, or Privileged \
...
That vampireís good word travels far, convincing others to allow \
...
},
{
  ...
  venue: "Camarilla",
  type: "negative",
  flavor: "Youíve committed some minor grievance against the Camarilla, \
